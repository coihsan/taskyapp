          ...
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96 CardStyle">
                  <CardHeader>
                    <Logo center className='pb-5'/>
                  ...
                  <CardContent className="grid gap-y-4">
                    <div className="grid grid-cols-2 gap-x-4">
                      <Clerk.Connection name="github" asChild>
                        <Button className='CardStyle' size="default" variant="outline" type="button" disabled={isGlobalLoading}>
